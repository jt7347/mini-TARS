...
class TARS_Servo_Controller:
    def __init__(self):
        ...
        self.portMain = 610
        self.starMain = 200
        self.portForearm = 570
        self.starForearm = 200
        self.portHand = 570
        self.starHand = 240
    ...
    # Arm shenanigans
    # port Main Arm
    def portMainPlus(self):
        global portMain
        portMain = portMain - 10
        self.pwm.set_pwm(3, 3, portMain)
        time.sleep(0.0001)
        print("increase starMain")
        print(portMain)

    def portMainMinus(self):
        global portMain
        portMain = portMain + 10
        self.pwm.set_pwm(3, 3, portMain)
        time.sleep(0.0001)
    ...
    # port Forearm
    def portForearmPlus(self):
        global portForearm
        portForearm = portForearm - 10
        self.pwm.set_pwm(4, 4, portForearm)
        time.sleep(0.0001)
        print("increase starForearm")
        print(portForearm)

    def portForearmMinus(self):
        global portForearm
        portForearm = portForearm + 10
        self.pwm.set_pwm(4, 4, portForearm)
        time.sleep(0.0001)
        print("decrease starForearm")
        print(portForearm) 

    # port Hand
    def portHandPlus(self):
        global portHand
        portHand = portHand - 10
        self.pwm.set_pwm(5, 5, portHand)
        time.sleep(0.0001)
        print("increase starHand")
        print(portHand)

    def portHandMinus(self):
        global portHand
        portHand = portHand + 10
        self.pwm.set_pwm(5, 5, portHand)
        time.sleep(0.0001)
    ...
    # starboard Main Arm
    def starMainPlus(self):
        global starMain
        starMain = starMain + 10
        self.pwm.set_pwm(6, 6, starMain)
        time.sleep(0.0001)
        print("increase starMain")
        print(starMain)

    def starMainMinus(self):
        global starMain
        starMain = starMain - 10
        self.pwm.set_pwm(6, 6, starMain)
        time.sleep(0.0001)
    ...
    # port Forearm
    def starForearmPlus(self):
        global starForearm
        starForearm = starForearm + 10
        self.pwm.set_pwm(7, 7, starForearm)
        time.sleep(0.0001)
        print("increase starForearm")
        print(starForearm)

    def starForearmMinus(self):
        global starForearm
        starForearm = starForearm - 10
        self.pwm.set_pwm(7, 7, starForearm)
        time.sleep(0.0001)
    ...
    # port Hand
    def starHandPlus(self):
        global starHand
        starHand = starHand + 10
        self.pwm.set_pwm(8, 8, starHand)
        time.sleep(0.0001)
        print("increase starHand")
        print(starHand)

    def starHandMinus(self):
        global starHand
        starHand = starHand - 10
        self.pwm.set_pwm(8, 8, starHand)
        time.sleep(0.0001)
